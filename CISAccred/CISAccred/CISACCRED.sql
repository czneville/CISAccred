...
(
	...
	C_SECTION NUMBER (5) NOT NULL, 
	CONSTRAINT CLASS_PRIMARY_KEY PRIMARY KEY (C_COURSE_NUM, C_SEMETER)
);
...
(
	...
	CONSTRAINT TASK_COURSE_FOREIGN_KEY FOREIGN KEY (C_COURSE_NUM) REFERENCES CIS_CLASS(C_COURSE_NUM)	
);
...
(
	...
	CONSTRAINT CLASS_FOREIGN_KEY FOREIGN KEY (C_SEMETER,C_COURSE_NUM) REFERENCES CIS_CLASS (C_SEMETER,C_COURSE_NUM),
